# Async Event Subscription Specification

> **NOTE**: This is the async version of the event-subscription-sync specification.

## Purpose

Provides async versions of event subscription using asyncio tasks.
